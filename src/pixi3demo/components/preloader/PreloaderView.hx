...
class PreloaderView extends ComponentView {
	...
	public function setup() {
		...
		Pixi3Demo.update.add(_onUpdate);
		Pixi3Demo.resize.add(_onResize);
	}
	...
	function _createLoadingBar() {
		...
		_loadingBar.beginFill(0xFF0000);
	...
	public function reset() {
		Pixi3Demo.update.remove(_onUpdate);
		Pixi3Demo.resize.remove(_onResize);
